...
if(isset($_POST['rregister'])){
    ...
    $sql = "INSERT INTO register_res(name,address,contact,email,pass) VALUES('$fname','$address','$contact','$email','$pass')";
    $mysql->query($sql);
...
<form action="resRegister.php" method="post">
  <div class="container">
    ...
    <hr>
    <label><b>Name of your organization:</b></label>
    <input type="text" placeholder="Full Name of your organization" name="fname" class="form-control" required style="border-radius: 4px">
    ...
    <input type="text" placeholder="Organization Mobile Number" name="contact" class="form-control" required style="border-radius: 4px">
    ...
    <button type="submit" class="btn btn-warning" name="rregister" id="button">Register</button>
  </div>

  <div class="container">
    <p>Already have an account? <a href="resLogin.php">Sign in</a>.</p>
  </div>
</form>
